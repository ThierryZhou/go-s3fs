...
import (
	...
	"github.com/ThierryZhou/go-s3fs/lib/file"
	"github.com/ThierryZhou/go-s3fs/lib/ranges"
	"github.com/ThierryZhou/go-s3fs/vfs/vfscache/downloaders"
	"github.com/ThierryZhou/go-s3fs/vfs/vfscache/writeback"
)
...
func (item *Item) _ensure(offset, size int64) (err error) {
	...
	if item.downloaders == nil {
		...
		// See: https://github.com/ThierryZhou/go-s3fs/issues/6190
		// See: https://github.com/ThierryZhou/go-s3fs/issues/6235
		if item.o == nil {
